            ...
            <div>
                <footer className='footer text-white py-4 '>
                    <div className='container'>
                        ...
                        <div className='botones-logos-texto d-flex justify-content-between'>

                            <div className='redes d-flex'>
                                <div className='red-uno px-3'><a href='https://www.instagram.com/and_amu_/'>
                                ...
                                <div className='red-dos px-3'><a href='https://github.com/AndresAmu'>
                                ...
                                <div className='red-tres px-3'><a href='https://www.youtube.com/channel/UCB5rjrpmaLWupWRMw4KV7mg'>
                            ...
                            <LinkRouter style={{textDecoration:'none'}} to='/Cities'><p className='botones-footer'>Cities</p></LinkRouter>
                            <p className='derechos'>All rights reserved MyTinerary® 2022</p>
                        </div>
                    </div>
